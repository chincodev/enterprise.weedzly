...
class NavbarAgencyLandingTwo extends Component {
    state = {
        collapsed: true,
        sidebarModal: false
    };
    ...
    render() {
        ...
        return (
            <>
                <nav id="navbar" className="navbar navbar-expand-md navbar-light navbar-area nav-style-two">
                    <div className="container">
                        <Link href="/agency-landing-2">
...
export default NavbarAgencyLandingTwo;
